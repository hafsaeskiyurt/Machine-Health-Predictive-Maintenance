...
**_Overview_**: Focused on the core of Industry 4.0, this project aimed to predict industrial equipment failures before they happen. By analyzing simulated sensor data, the model determines whether a machine is in a "healthy" or "at risk" state, which is a critical task for reducing downtime in manufacturing.
...
**_Dataset_**: [https://www.kaggle.com/datasets/stephanmatzka/predictive-maintenance-dataset-ai4i-2020](https://www.kaggle.com/datasets/stephanmatzka/predictive-maintenance-dataset-ai4i-2020)
